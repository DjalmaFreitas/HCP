...
public class SSLExampleServlet extends HttpServlet {
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     String clientKeystoreName = "myKeystore";
     ...
     String trustedCAKeystoreName = "myKeystore";
...
/*
   ...
   */
  callHTTPSServer(response, host, port, path, clientKeystorePassword, clientKeystore, clientKeystore);
}
