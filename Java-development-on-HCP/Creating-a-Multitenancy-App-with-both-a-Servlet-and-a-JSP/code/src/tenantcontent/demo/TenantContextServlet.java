...
public class TenantContextServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			writer.println("<html>");
			writer.println("<head>");
			writer.println("<title>SAP HCP - Tenant Context Demo Application</title>");
			writer.println("</head>");
			writer.println("<body>");
			writer.println("<h2> Welcome to the SAP HANA Cloud Platform Tenant Context demo application</h2>");
